...
import { CheckCircleOutlined, ExclamationCircleOutlined, ClockCircleOutlined, CloseCircleOutlined } from "@ant-design/icons";
...
const columns: ColumnsType<DeploymentItem> = [
  ...
  },
  {
    ...
    render: (value: string) => (
      <span title={formatTime(value, "absolute")}>
        {formatTime(value, "relative")}
      </span>
    ),
  },
];
  ...
  return (
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 16 }}>
        <Button type="primary" onClick={() => router.push(`/cluster/${clusterId}/deployment/create`)}>
          新建
        </Button>
        <Select
          placeholder="选择命名空间"
