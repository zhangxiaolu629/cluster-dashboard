...
export default function HomePage({ initialClusters = [], initialLoaded = false }: HomePageProps) {
  ...
  const [stats, setStats] = useState<ClusterStats>({ total: 0, running: 0, failed: 0, creating: 0 });
  ...
  return (
    <div style={{ padding: 0, minHeight: "100vh", background: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)" }}>
      <div style={{ padding: "48px 24px 24px" }}>
        ...
        <div style={{ textAlign: "center", marginTop: 48, paddingBottom: 24 }}>
          <Text style={{ color: "rgba(255, 255, 255, 0.7)", fontSize: 13 }}>
            K8s 集群管理平台 © 2024 · 提供稳定、可靠的集群管理服务
          </Text>
        </div>
      </div>
    </div>
